  ...
  return (
    <div className="app-layout">
      ...
      <div className="app-layout__body">
        {isSidebarOpen && (
          <div className="app-sidebar__overlay" onClick={() => setIsSidebarOpen(false)} aria-hidden="true" />
        )}
          ...
          <div className="app-sidebar__inner">
            <nav className="app-sidebar__nav">
              <ul className="app-sidebar__menu">
                <li>
                  <NavLink to="/new-search" className={({ isActive }) => `app-sidebar__link${isActive ? ' app-sidebar__link--active' : ''}`} onClick={closeSidebarOnMobile}>
                ...
                <li>
                  <NavLink to="/historial" className={({ isActive }) => `app-sidebar__link${isActive ? ' app-sidebar__link--active' : ''}`} onClick={closeSidebarOnMobile}>
                    <span className="app-sidebar__icon" aria-hidden="true">
                ...
                <li>
                  <NavLink to="/manualfilter" className={({ isActive }) => `app-sidebar__link${isActive ? ' app-sidebar__link--active' : ''}`} onClick={closeSidebarOnMobile}>
                    <span className="app-sidebar__icon" aria-hidden="true">
                ...
                {user?.role === 'admin' && (
                  <li>
                    <NavLink to="/admin" className={({ isActive }) => `app-sidebar__link${isActive ? ' app-sidebar__link--active' : ''}`} onClick={closeSidebarOnMobile}>
                      <span className="app-sidebar__icon" aria-hidden="true">
            ...
            <div className="app-sidebar__footer">
              <ul className="app-sidebar__menu">
                <li>
                  <NavLink to="/configurar" className={({ isActive }) => `app-sidebar__link${isActive ? ' app-sidebar__link--active' : ''}`} onClick={closeSidebarOnMobile}>
                    <span className="app-sidebar__icon" aria-hidden="true">
                ...
                <li>
                  <button className="app-sidebar__link app-sidebar__link--btn" onClick={() => { handleLogout(); closeSidebarOnMobile(); }}>
                    <span className="app-sidebar__icon" aria-hidden="true">
